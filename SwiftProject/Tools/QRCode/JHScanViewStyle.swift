...
///扫码区域动画效果
public enum JHScanViewAnimationStyle
{
...
///扫码区域4个角位置类型
public enum JHScanViewPhotoframeAngleStyle
{
...
public struct JHScanViewStyle
{
 ...
 /// 是否需要绘制扫码矩形框，默认YES
    ...
    */
    ...
    @brief  扫码区域的4个角类型
    */
    public var photoframeAngleStyle = JHScanViewPhotoframeAngleStyle.Outer
    ...
    */
    ...
    @brief  扫码动画效果:线条或网格
    */
    public var anmiationStyle = JHScanViewAnimationStyle.LineMove
