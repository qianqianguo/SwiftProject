...
class JHScanNetAnimation: UIImageView {

    var isAnimationing = false
    var animationRect:CGRect = CGRect.zero

    static public func instance()->JHScanNetAnimation
    {
        return JHScanNetAnimation()
    }
    ...
    @objc func stepAnimation()
    {
        ...
        UIView.animate(withDuration: 1.2, animations: { () -> Void in
            ...
            self.frame = frame;
                ...
                self.perform(#selector(JHScanNetAnimation.stepAnimation), with: nil, afterDelay: 0.3)
